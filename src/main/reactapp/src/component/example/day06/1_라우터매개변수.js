...
import { useSearchParams } from 'react-router-dom'; // 4-1. HTTP URL 경로상의 쿼리스트링 매개변수 호출 라이브러리 호출
import { useParams } from 'react-router-dom';  // 4-2. HTTP URL 경로상의 경로매개변수 호출 라이브러리 호출
