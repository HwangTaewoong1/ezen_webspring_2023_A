...
public class LombokTest {
    public static void main(String[] args) {
        ...
        // 4. toString() 메소드 사용할 때. : 객체의 필드정보를 출력하는 함수
        System.out.println(consoleDto1);

        // 5.
            // 1. 빈생성자 또는 풀생성자 아닌 [ 정의된 생성자가 아닌 생성자를 사용하고 싶을때 생성자 정의해야만 가능 ]
       // ConsoleDto consoleDto3 = new ConsoleDto("공부", true); // 정의된 생성자만 사용할 수 있다.
            // 2. 생성자는 매개변수의 순서가 다르면 오류가 발생...
       // ConsoleDto consoleDto4 = new ConsoleDto(true , "공부" , 0 , LocalDate.now() ); // 매개변수 순서와 타입일치 X
        ...
        // * 빌더 패턴 : 복잡한 객체 [생성자] 생성과정을 다양한 구성의 객체를 만드는 패턴 지원 [ bulider() 함수 지원 ]
